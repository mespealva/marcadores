...
class WebmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webmark" do
    assert_difference('Webmark.count') do
      post webmarks_url, params: { webmark: { cat_id: @webmark.cat_id, type_id: @webmark.type_id, url: @webmark.url } }
    end
  ...
  test "should update webmark" do
    patch webmark_url(@webmark), params: { webmark: { cat_id: @webmark.cat_id, type_id: @webmark.type_id, url: @webmark.url } }
